  ...
  return (
    <Wrapper className="">
        ...
        <ul className="flex justify-center items-center gap-3 w-10/12 mx-auto mt-10 ">
          ...
          <li className="py-1 w-1/3 rounded-full font-semibold text-xl text-gray-300">Place Order</li>
          <li className="py-1 w-1/3 rounded-full font-semibold text-xl text-gray-300"> Payments</li>
        </ul> 
        <ul className="flex justify-center items-center gap-3 w-10/12 mx-auto mb-5">
          ...
          <li className="py-1 w-1/3 rounded-full  bg-gray-300"></li>
          <li className="py-1 w-1/3 rounded-full  bg-gray-300"></li>
        </ul> 
    </Wrapper>
  );
