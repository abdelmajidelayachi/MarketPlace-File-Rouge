  ...
  return (
    <div>
      <div className=" max-w-screen-xl m-auto ">
        <Nav user={user!==null&&user} active="home" />
    ...
    <div className="flex flex-col items-center justify-center w-full md:w-1/3 md:mt-6 md:border h-fit">
      <div className="py-8 "> 
        <img  src={require(`../../assets/images/profiles/${user?user.profile_photo_path:'default_profile.png'}`)} alt="profile" className="rounded-full w-48 h-48"/>
      </div>
    ...
    <div className="flex flex-col w-full md:w-2/3 px-8 mt-4">
      <div className="flex gap-10 ">
        <div className="md:text-xl text-base text-gray-800">
      ...
      {user!==null&&(current === "change-password" ? <ChangePassword/>:<ProfileInformation updateInfo={(user)=>{setUser(user)}} />)}
